...
namespace Logikfabrik.Overseer.WPF.Provider.Codeship.ViewModels
{
    ...
    public class EditConnectionViewModel : WPF.ViewModels.EditConnectionViewModel<Codeship.ConnectionSettings>
    {
        /// <summary>
...
#pragma warning disable S107 // Methods should not have too many parameters
        public EditConnectionViewModel(
            ...
            IEditConnectionSettingsViewModelFactory<Codeship.ConnectionSettings, EditConnectionSettingsViewModel> editConnectionSettingsFactory,
            ...
            Codeship.ConnectionSettings currentSettings)
            : base(
                  platformProvider,
                  logService,
