...
namespace Logikfabrik.Overseer.WPF.ViewModels.Factories
{
    ...
    public interface IBuildViewModelFactory
    {
        ...
        BuildViewModel Create(string projectName, string id, string branch, string versionNumber, string requestedBy, IEnumerable<IChange> changes, BuildStatus? status, DateTime? startTime, DateTime? endTime, TimeSpan? runTime, Uri webUrl);
    }
}
