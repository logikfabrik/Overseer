...
namespace Logikfabrik.Overseer.WPF.Provider.VSTeamServices
{
    ...
    public class Module : NinjectModule
    {
        ...
        public override void Load()
        {
            ...
            ViewLocator.AddNamespaceMapping("Logikfabrik.Overseer.WPF.Provider.VSTeamServices.ViewModels", "Logikfabrik.Overseer.WPF.Provider.VSTeamServices.Views.Views");
        }
    }
}
