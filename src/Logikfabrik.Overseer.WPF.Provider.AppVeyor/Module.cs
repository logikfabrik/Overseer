...
namespace Logikfabrik.Overseer.WPF.Provider.AppVeyor
{
    ...
    public class Module : NinjectModule
    {
        ...
        public override void Load()
        {
            ...
            Bind<WPF.ViewModels.Factories.IConnectionViewModelFactory>().To<WPF.ViewModels.Factories.ConnectionViewModelFactory<ConnectionSettings, ConnectionViewModel>>();
